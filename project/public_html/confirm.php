...
#h1 
{
	...
	font-weight: bolder;
	font-size: 250%;
	text-shadow: rgb(22,23,31) 1px 1px 40px;
	text-align: left;
	margin: auto;
	position: relative;
	display: flex;
...
#verification_p, #verification_h1
{
	margin: auto;
	text-align: center;
	padding-top: 5%;
...
.change
{
	color: rgb(235,100,130)  !important;
	text-decoration: none;
	padding-left: 7px;
}
.change:hover
...
/* Message explaining the situation after sign up or sign in*/
.explain_div
{
	position: absolute;
	top: 0;
...
/* Breakpoint */
/* Medium devices (Tablets and small laptops, less than 1000px) */
...
{	
	...
	#sign_up_form, #sign_in_form, #forgotten_form,#reset_form
	{
		height: 111%;
		width: 100%;
		top: -11%;
...
/* Breakpoint */
/* XS devices (landscape phones, less than 400px) */
@media only screen and (max-width: 400.98px) , (max-height: 767.98px)
{	
	#h1
	{
		font-size: 160%;
...
<?php if($is_confirm){?>
	<body>
		...
		<div class="container-fluid main_container">
			<img src="images/viyolin.webp" alt="Viyolin Dersi Alan Bir Öğrenci" class="img-fluid" id="background-img" />
		...
		<div id="info_div">
			<h1>Öğrenciyseniz</h1>
			<img src="images/info_search.webp" alt="Arama Logosu"  class="img-fluid info_img" />
			<p class="info_p">
				Ana sayfada arama yapın ve özel ders almak istediğiniz alanı arayın: Tenis, matematik, biyoloji, fen, gitar, yüzme, keman,
				fizik, kimya, İngilizce, yabancı dil, lise sınavı, üniversite sınavı ve aklınıza gelen her alanda arama yapın.				
			</p>
			<img src="images/info_filter.webp" alt="Filtreleme Logosu"  class="img-fluid info_img" />
			<p class="info_p">
			...
			<img src="images/info_demand.webp" alt="Talep Logosu"  class="img-fluid info_img" />
			<p class="info_p">
			...
			<img src="images/info_contact.webp" alt="İletişim Logosu"  class="img-fluid info_img" />
			<p class="info_p">
		...
		<h1>Öğretmenseniz</h1>
		<img src="images/info_register.webp" alt="Kayıt Logosu"  class="img-fluid info_img" />
		<p class="info_p">
		...
		<img src="images/info_profil.webp" alt="Profil Logosu"  class="img-fluid info_img" />
		<p class="info_p">
		...
		<img src="images/info_contact.webp" alt="Filtreleme Logosu"  class="img-fluid info_img" />
		<p class="info_p">
