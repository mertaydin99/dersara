<?php
// This script checks if profile of user created, if that's the case it retrieves the info else displays a warning to user
session_start();
				...
				<div class="container-fluid main_container">
					...
					<div class="container-fluid" id="body">
						...
						<div class="row"> 
							...
							<div class="alert alert-danger" role="alert" id="error_div4" tabindex="4">Veritabanına bağlanırken bir sorun yaşandı. Tekrar deneyiniz.</div>
...
// Get the user id
$stmt = $conn->prepare("SELECT profile.img_url, profile.gender, profile.title, profile.introduction, profile.city, profile.province, profile.preference, profile.price, profile.keyword FROM profile INNER JOIN teachers ON profile.user_id = teachers.id WHERE teachers.email=?");
...
if ($row = $result->fetch_assoc()) 
{
	...
	$row['province'] = htmlspecialchars($row['province']);
